<h1 align="center">Olá 👋, eu sou Gabriel Charlante</h1>

<h3 align="center">
Desenvolvedor Python Full Stack | ETL & Data Pipelines | Automação de Processos
</h3>

<p align="center">
🚀 Python • Django • FastAPI • React • Airflow • AWS • GCP
</p>
...
automação de processos, integração de sistemas e engenharia de dados.
...
e desenvolvimento de aplicações web escaláveis.
...
<<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/djangorest/djangorest-line.svg" width="45" />        
...
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/heroku/heroku-original.svg" width="45" />       
...
### 💼 Desenvolvedor Python Pleno — Dot Digital Group
- ETL e pipelines de dados
- Apache Airflow
- AWS & GCP
- Deploy em OKD/OpenShift
- Django & FastHTML
- Integrações entre serviços

### 💼 Desenvolvedor Python Pleno — PinPag
- Sistemas legados Django
- APIs REST
- Celery
- Docker
- PostgreSQL
...
### 💼 Desenvolvedor de Software — Bora Transportes
...
<p align="center">
<img src="https://streak-stats.demolab.com?user=G4bR13LChArLaNtE&theme=tokyonight"/>
</p>
...
### 📦 Sistema de Automação com Django + Celery
Sistema para automação de processos e tarefas assíncronas.

### 📊 ETL & Data Pipeline
Pipeline de processamento de dados com Airflow no GCP.

### 🛒 E-commerce Web
Projeto completo de loja virtual utilizando Flask.

### ⏰ Sistema de Fechamento de Horas.
Sistema interno para fechamento de horas dos colaboradores, integrado com Financeiro e RH — automação de cálculos, validações e geração de relatórios utilizando FastAPI e Bootstrap.

### 🚚 Sistema Interno de Transportadora.
Portal interno para gestão operacional: cálculo de quantidade de produtos, solicitação de uniformes ao RH, correção de ponto mal batido, controle de motoristas e veículos, emissão de relatórios gerenciais utilizando DRF e React.
...
🎓 Bacharelado em Sistemas de Informação — Faculdade Impacta  
🎓 Tecnólogo em Eletrônica Industrial — FATEC-SP

---

## 🌎 Contato

📧 gabrielcharlante@gmail.com
